import {SwordsList} from "./data.Swords.zh-CN.ts"
import {FlailsList} from "./data.Flails.zh-CN.ts"
import {SpearsList} from "./data.Spears.zh-CN.ts";
import {BoomerangsList} from "./data.Boomerangs.zh-CN.ts";
